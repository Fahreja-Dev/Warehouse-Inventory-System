...
/*
namespace adalah sebuah ruang lingkup yang berfungsi sebagai wadah nama-nama identifier.
Dengan namespace, kita bisa punya banyak fungsi, class, ata struct dengan nama yang sama. Dan tetap bisa dibedakan karena berada di namespace berbeda.
*/
namespace Color {
